...
<link rel='stylesheet' id=''
	href='/style.css?v=<?php echo $service->info->version?>'
...
<body>
	<div id="page">
		<header>
			...
			<a href="/" class="logo2" title="Squeezeplug"></a>
			<div class="chooseplayer">
				...
				<span class="headerinfo">
					<?php if ($service->info->removedonate != 1) echo _('DONATE-BUTTON-SQUEEZEPLUG'); ?>		

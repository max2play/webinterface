...
<div class="entry-content">
	...
	<form action="" method="get">
		...
		<?php echo _("MiniDLNA is a Service for sharing media-data from Max2Play with other devices in your network.") ?><br /><br />
		...
		<?php } else { ?>
			<input type="button" id="uninstallMiniDLNA" name="uninstallMiniDLNA" onclick="document.getElementById('action').value='uninstallMiniDLNA';submit();" value="<?php echo _("Uninstall MiniDLNA") ?>" /><br /><br />
			<?php echo _("Media Path") ?> <input style="width: 90%;" type="text" name="minidlnaMediapath" value="<?php echo $dlnaserver->minidlna['mediapath'] ?>" /><br />		
	...
	<textarea id="debug" rows="30" cols="70" style="display:none;"><?php foreach ($dlnaserver->view->debug as $key => $debug) {
			echo "#### ". $key. " ####\n"; 
			 echo $debug." \n\n"; 
		 }?>
	</textarea>

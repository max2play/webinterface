...
$message = $start->view->message;
	...
	<a style="float: left;"
		href="http://shop.max2play.com/en/max2play-full-license.html/"
		target="_blank"><img
		src="http://shop.max2play.com/media/wysiwyg/Premium-box-en_white.png" /></a>
	<br />
	<br />
	...
	<iframe width="560" height="315"
		src="<?php echo _("http://www.youtube.com/embed/pZB4aSiW4c0")?>"
	...
	<div id="dialog-setupstartpage"
		title="<?php echo _('Customize Max2Play for a special audio card?');?>">
		<p>
			<span class="ui-icon ui-icon-check"
				style="float: left; margin: 12px 12px 20px 0;"></span><?php echo _('Get the most out of your audio card with the specialized setup page. Just click on the manufacturer below to install the plugin.');?></p>
		...
		<ul>
			<li><a style="color: #fff;" class="download-button clickloading"
				href="?action=installstartpageplugin&hardware=justboom">JustBoom</a></li>
			<li><a style="color: #fff;" class="download-button clickloading"
				href="?action=installstartpageplugin&hardware=hifiberry">HifiBerry</a></li>
			<li><a style="color: #fff;" class="download-button clickloading"
				href="?action=installstartpageplugin&hardware=iqaudio">IQAudIO</a></li>
			<li><a style="color: #fff;" class="download-button clickloading"
				href="?action=installstartpageplugin&hardware=allo">ALLO</a></li>
			<li><a style="color: #fff;" class="download-button clickloading"
				href="?action=installstartpageplugin&hardware=audiophonics">Audiophonics</a></li>
		</ul>

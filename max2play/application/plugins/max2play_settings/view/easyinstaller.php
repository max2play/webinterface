...
<?php echo _('You may change all settings later, but for the first start, it is suggested to select something. The mediacenter Kodi is available and preinstalled in every setup.') ?><br />
<br />
<div id="purposeselect">	
	...
	<div>
		...
		<a class="button-small clickloading" href="#"
			onclick="document.getElementById('action').value='save_purpose';document.getElementById('purpose').value='squeeze';$('#form1').submit();"><?php echo _("Select this setup!") ?></a>
	...
	<div>
		...
		<a class="button-small clickloading" href="#"
			onclick="document.getElementById('action').value='save_purpose';document.getElementById('purpose').value='airplay';$('#form1').submit();"><?php echo _("Select this setup!") ?></a>
	...
	<div>
		...
		<a class="button-small clickloading" href="#"
			onclick="document.getElementById('action').value='save_purpose';document.getElementById('purpose').value='mpd';$('#form1').submit();"><?php echo _("Select this setup!") ?></a>
		</p>
	</div>
</div>

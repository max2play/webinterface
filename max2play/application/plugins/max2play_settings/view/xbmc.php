...
<div class="entry-content">
	...
	<?php } ?>
		...
		<input id="downloadurl" type="text" value="<?php if ($sp->getHardwareInfo() == "Raspberry PI") echo 'http://steinerdatenbank.de/software/kodi-15.tar.gz'; ?>" name="downloadurl" style="width:200px;" /><br /><br /> 	
